...
import ApplicationList from '../components/application-list-table'; // Adjust path if needed
import AppointmentScheduling from '../components/appointment-scheduling'; // Adjust path if needed
